...
public final class CertificateHelper {
    ...
    public static KeyStore loadAssetKeyStore(Context context, String assetsName, String password) throws GeneralSecurityException,
            IOException {
    ...
    private static SSLContext newSSLContext() throws NoSuchAlgorithmException {
        try {
            VPNLog.d(TAG, "Using protocol " + SSL_CONTEXT_PROTOCOL);
            return SSLContext.getInstance(SSL_CONTEXT_PROTOCOL
            /* , PROVIDER_NAME */);
        } catch (NoSuchAlgorithmException e) {
            VPNLog.w(TAG,"Protocol not available, falling back to ", e);
